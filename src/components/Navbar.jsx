...
function Navbar() {
  ...
  return (
    <>
      <nav className="z-[100]  sm:mt-0 bg-[#b6c0a7] backdrop-blur-lg border-[#0244a5b3] border-b-2 ">
        <div className="container-wrapper border-none sm:border-2 border-[#fff] h-14 lg:h-[5rem] 2xl:h-20 rounded-2xl flex justify-between lg:justify-normal lg:grid lg:grid-cols-[1fr_16rem_1fr] gap-8 items-center">
          <div className="items-center justify-evenly text-base font-medium text-white hidden lg:flex">
            <a
              href="https://t.me/puppypug"
